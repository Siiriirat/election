...
<form action="updateadmin" method="POST" id="demo1" class="demo" style="display:none;" autocomplete="off" enctype="multipart/form-data">
<div class="container">
<div class="row">
<div class="col-md-3">
<div class="card">
  ...
  <div class="card" >
    ...
    <div class="row">
      ...
      <div class="col-md-5">
          ...
          <p>
            <label>อำเภอ</label>
            <input class="form-control" name="amphoe" value="{{$header->amphoe}}" type="text" readonly>
        </p>
      ...
      <div class="col-md-5">
        ...
        <p>
            ...
            <input class="form-control" name="password" value="{{$admin->password}}" type="password">
        </p>
          <p>
            <label>ตำบล</label>
            <input class="form-control" name="district" value="{{$header->district}}" type="text" readonly>
          </p>
        <p>
            <label>จังหวัด</label>
            <input class="form-control" name="province" value="{{$header->province}}" type="text" readonly>
          </p>
        <input type="hidden" class="form-control" name="header_id" value="{{$admin->header_id}}">
      </div>
        <div class="col-md-1"></div>
          </div>
          <div class="row">
